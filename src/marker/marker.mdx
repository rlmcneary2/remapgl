...
# Marker
The `<Marker/>` component is a child of [Map](./src/map/map.mdx), it causes a marker to appear at a specific location on a map. Markers can have a [Popup](/popup) that provides more information.
