...
menu: Components
name: Layer
route: /src/layer/mapboxgl/layer.mdx
---
...
# Layer
The `<Layer/>` component is a child of [Map](/src/map/map.mdx), it causes a layer to be added to a map. Layers are not DOM objects, they are rendered by the Map in its presentation layer, for example a canvas element.
